    ...
    <div class="layout-px-spacing">
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0);">payments Payments</a></li>
                                            ...
                                            if (!empty($payments)) {
                                                ...
                                                foreach ($payments as $payment) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('admin/generate_pdf_and_send_email?id=' . $payment['userid'] . '&template=invoice&download=1&type='.$payment['type']); ?>"
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © 2025 Adhar credit, All rights reserved.</p>
            </div>
        </div>
    </div>
